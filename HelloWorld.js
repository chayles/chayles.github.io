...
switch (continent) {
	...
	default:
		...
		if (pickCity === ("banff" || "seattle" || "belmopan" || "calgary" || "san francisco" || "belize city" || "golden" || "portland" || "nassau" ||
			|| "kelowna" || "las angeles" || "bridgetown" || "montreal" || "anaheim" || "tikal" || "toronto" || "scottsdale" || "vancouver"
			|| "sedona" || "victoria" || "albuquerque" || "las vegas" || "park city" || "salt lake city" || "sun valley" || "big sky"
			|| "jackson hole" || "telluride" || "dallas" || "rapid city" || "kadoka" || "cody" || "chicago" || "philadelphia" || "jersey city"	
			|| "newark" || "new york city" || "new haven" || "baltimore" || "nashville" || "miami" || "orlando" || "tampa" || "charlotte"	
			|| "wilmington" || "raleigh" || "maui" ||"lanai")) {
		...
		else {console.log("Hmmm, we can't seem to find that. Maybe look in our footer to find a good link!")};
};
